		...
		namespace {
			...
			public:
				...
				int zero_mask() const {
					...
					return (cmp._vecb0[0] & 1) | (cmp._vecb0[1] & 2) | (cmp._vecb1[0] & 4) | (cmp._vecb1[1] & 8);
				}

				template <uint64_t mask>
				static std::enable_if_t<mask == 0, Vec256<double>> __inline_attrs
					blend(const Vec256<double>& a, const Vec256<double>& b) {
					return a;
				}

				template <uint64_t mask>
				static std::enable_if_t<mask == 3, Vec256<double>> __inline_attrs
					blend(const Vec256<double>& a, const Vec256<double>& b) {
					return { b._vec0, a._vec1 };
				}

				template <uint64_t mask>
				static std::enable_if_t<(mask & 15) == 15, Vec256<double>> __inline_attrs
					blend(const Vec256<double>& a, const Vec256<double>& b) {
					return b;
				}

				template <uint64_t mask>
				static ::std::enable_if_t<(mask > 0 && mask < 3), Vec256<double>>
					...
					return {
						(__vd)vec_sel(a._vec0, b._vec0, (__vllb)mask_1st), a._vec1 };
				}

				template <uint64_t mask>
				static std::enable_if_t<(mask > 3) && (mask & 3) == 0, Vec256<double>>
					__inline_attrs blend(const Vec256<double>& a, const Vec256<double>& b) {
					...
					return {
						a._vec0, (__vd)vec_sel(a._vec1, b._vec1, (__vllb)mask_2nd) };
				}
				...
				static Vec256<value_type> __inline_attrs
					...
					return {
						vec_vsx_ld(offset0, tmp_values), vec_vsx_ld(offset16, tmp_values) };
				}
