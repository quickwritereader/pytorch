		...
		namespace {
			...
			public:
				...
				Vec256<c10::quint8> __inline_attrs relu(Vec256<c10::quint8> zero_point) {
					return {
						vec_max(_vec0, zero_point._vec0),
				...
				Vec256<c10::quint8> __inline_attrs
					...
					return {
						vec_min(max0, q_six._vec0),
						vec_min(max1, q_six._vec1) };
				}
				...
				int_vec_return_type widening_subtract(Vec256<c10::quint8> b) const {
					...
					return { Vec256<c10::qint32>(veci0 - vecBi0,veci1 - vecBi1),
			...
			template <>
			Vec256<c10::quint8> inline minimum(const Vec256<c10::quint8>& a, const Vec256<c10::quint8>& b) {
				return a.minimum(b);
			}
