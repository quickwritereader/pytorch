...
class Vec256<float> {
 ...
 public:
  ...
  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 6,
      Vec256<float>>
  ...
  template <int64_t mask>
  static std::enable_if_t<blendChoice(mask) == 7,
      Vec256<float>>
      __inline_attrs blend(const Vec256<float>& a, const Vec256<float>& b) {
      const __vib mask_2nd = VsxMask2(mask);
      // generated masks
  ...
  void dump() const {
      std::cout << _vec0[0] << "," << _vec0[1] << "," << _vec0[2] << "," << _vec0[3] << ",";
      std::cout << _vec1[0] << "," << _vec1[1] << "," << _vec1[2] << "," << _vec1[3] << std::endl;
  }
