		...
		namespace {
			...
			public:
				...
				static std::enable_if_t<(mask > 0 && mask < 255), Vec256<int16_t>>
					...
					return {
						(__vshi)vec_sel(a._vec0, b._vec0, (__vshb)mask_1st), a._vec1 };
				}
				...
				static std::enable_if_t<
					...
					// generated masks
					return {
						b._vec0, (__vshi)vec_sel(a._vec1, b._vec1, (__vshb)mask_2nd) };
				}
				...
				static std::enable_if_t<
					...
					// generated masks
					return {
						a, (__vshi)vec_sel(a._vec1, b._vec1, (__vshb)mask_2nd) };
				}
