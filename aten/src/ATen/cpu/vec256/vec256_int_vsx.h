...
class Vec256<int64_t> {
 ...
 public:
  ...
  static c10::guts::enable_if_t<(mask > 0 && mask < 3), Vec256<int64_t>>
    ...
    return Vec256<int64_t>{(__vlli)vec_sel(a._vec0, b._vec0, (__vllb)mask_1st),
                           a._vec1};
  }
  ...
  static Vec256<int64_t> __inline_attrs blendv(
    ...
    return Vec256<int64_t>{vec_sel(a._vec0, b._vec0, mask._vecb0),
  ...
  loadu(const void* ptr, int64_t count = size()) {
    if (count == size()) {
      return Vec256<int64_t>{
          vec_vsx_ld(offset0, reinterpret_cast<const __vlli*>(ptr)),
          vec_vsx_ld(offset16, reinterpret_cast<const __vlli*>(ptr))};
    }
    ...
    __vlli* vtmp = reinterpret_cast<__vlli*>(tmp_values);
    return Vec256<int64_t>{vtmp[0], vtmp[1]};
  }
  void __inline_attrs store(void* ptr, int count = size()) const {
    if (count == size()) {
      vec_vsx_st(_vec0, offset0, reinterpret_cast<__vlli*>(ptr));
      vec_vsx_st(_vec1, offset16, reinterpret_cast<__vlli*>(ptr));
    } else if (count > 0) {
...
class Vec256<int32_t> {
 ...
 public:
  ...
  static Vec256<int32_t> __inline_attrs
  loadu(const void* ptr, int64_t count = size()) {
    if (count == size()) {
      return Vec256<int32_t>{
          vec_vsx_ld(offset0, reinterpret_cast<const int32_t*>(ptr)),
          vec_vsx_ld(offset16, reinterpret_cast<const int32_t*>(ptr))};
    }
    ...
    __vi* vtmp = reinterpret_cast<__vi*>(tmp_values);
    return Vec256<int32_t>{vtmp[0], vtmp[1]};
  }
  void __inline_attrs store(void* ptr, int count = size()) const {
    if (count == size()) {
      vec_vsx_st(_vec0, offset0, reinterpret_cast<int32_t*>(ptr));
      vec_vsx_st(_vec1, offset16, reinterpret_cast<int32_t*>(ptr));
    } else if (count > 0) {
...
class Vec256<int16_t> {
 ...
 public:
  ...
  static Vec256<int16_t> __inline_attrs
  loadu(const void* ptr, int64_t count = size()) {
    if (count == size()) {
      return Vec256<int16_t>{
          vec_vsx_ld(offset0, reinterpret_cast<const int16_t*>(ptr)),
          vec_vsx_ld(offset16, reinterpret_cast<const int16_t*>(ptr))};
    }
    ...
    __vshi* vtmp = reinterpret_cast<__vshi*>(tmp_values);
    return Vec256<int16_t>{vtmp[0], vtmp[1]};
  }
  void __inline_attrs store(void* ptr, int count = size()) const {
    if (count == size()) {
      vec_vsx_st(_vec0, offset0, reinterpret_cast<int16_t*>(ptr));
      vec_vsx_st(_vec1, offset16, reinterpret_cast<int16_t*>(ptr));
    } else if (count > 0) {
